...
# ========== CHANAGE : n_class=2 -> n_class=5 ======================
def CapsNetR3(input_shape, n_class=2):
    x = layers.Input(shape=input_shape)
    # Convolution Phase
    # Layer 1: 2D Convolution ==============================================
    conv1 = layers.Conv2D(filters=16, kernel_size=5, strides=1, padding='same',
    ...
    # Layer 1: Primary Capsule: Conv : Routing 1 : 16D * 2 Caps
    primary_caps = ConvCapsuleLayer(kernel_size=5, num_capsule=2, num_atoms=16,
                                    strides=2, padding='same', routings=1,
                                    name='primarycaps')(conv1_reshaped)

    # Layer 2: Convolutional Capsule : Routing 3 : 16D * 4 Caps ============
    conv_cap_2_1 = ConvCapsuleLayer(kernel_size=5, num_capsule=4, num_atoms=16,
                                    strides=1, padding='same', routings=3,
                                    name='conv_cap_2_1')(primary_caps)

    # Layer 2: Convolutional Capsule : Routing 3 : 32D * 4 Caps
    ...
    # Layer 1 Up: Deconvolutional Capsule : Routing 3 : 32D * 4 Caps
    ...
    # Layer 2 Up: Deconvolutional Capsule : Routing 3 : 16 D * 4 Caps
    deconv_cap_2_1 = DeconvCapsuleLayer(kernel_size=4, num_capsule=4,
                                        num_atoms=16, upsamp_type='deconv',
                                        scaling=2, padding='same', routings=3,
    ...
    # Layer 2 Up: Deconvolutional Capsule : Routing 3 : 16D * 4 Caps
    ...
    # Layer 3 Up: Deconvolutional Capsule : Routing 3 : 16D * 2 Caps
...
def CapsNetR1(input_shape, n_class=2):
    ...
    conv_cap_2_1 = ConvCapsuleLayer(kernel_size=5, num_capsule=4, num_atoms=16,
                                    strides=1, padding='same', routings=1,
                                    name='conv_cap_2_1')(primary_caps)
    ...
    deconv_cap_1_2 = ConvCapsuleLayer(kernel_size=5, num_capsule=4,
                                      num_atoms=32, strides=1, padding='same',
                                      routings=1, name='deconv_cap_1_2')(up_1)
    ...
    deconv_cap_2_2 = ConvCapsuleLayer(kernel_size=5, num_capsule=4,
                                      num_atoms=16, strides=1, padding='same',
                                      routings=1, name='deconv_cap_2_2')(up_2)
    ...
    # Models for training and evaluation (prediction)
    train_model = models.Model(inputs=[x, y], outputs=[out_seg,
