...
Original Paper by Rodney LaLonde and Ulas Bagci
(https://arxiv.org/abs/1804.04241)
Code written by: Rodney LaLonde
If you use significant portions of this code or the ideas from our paper,
please cite it :)
If you have any questions, please email me at lalonde@knights.ucf.edu.

This file is used for training models.
Please see the README for details about training.
'''
...
def train(args, train_list, val_list, u_model, net_input_shape):
    ...
    history = model.fit_generator(
        ...
        validation_steps=500, epochs=200, callbacks=callbacks, verbose=1)
